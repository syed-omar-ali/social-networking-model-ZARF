...
?>
		...
		<div class="panel panel-info">
		  ...
		  <div class="col-md-6">
		  <!--<div class="btn-group">-->
		  <button type="button" id="like-<?php echo $entryId; ?>" class="btn btn-default" data-l="<?php echo $entryId; ?>"><span class="glyphicon glyphicon-thumbs-up"></span></button>
		  <button type="button"  id="love-<?php echo $entryId; ?>" class="btn btn-default" data-l="<?php echo $entryId; ?>"><span class="glyphicon glyphicon-heart"></span></button>
		  <button type="button"  id="dislike-<?php echo $entryId; ?>" class="btn btn-default" data-l="<?php echo $entryId; ?>"><span class="glyphicon glyphicon-thumbs-down"></span></button>
		...
		<div class="text-right" >
		  ...
		  <button type="button" class="btn btn-default"><a href="loadSingleEntry.php?id=<?php echo $row['entry_id']; ?>" target="_blank" >Get Sharable Link</a></button>
